...
def predict_model(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            Predictions.objects.create(height=height, weight=weight, sex=sex, prediction=prediction_name)
            return render(
                request, "bmi/home.html", {"form": form, "prediction": prediction, "prediction_name": prediction_name}
            )
    else:
        form = ModelForm()
